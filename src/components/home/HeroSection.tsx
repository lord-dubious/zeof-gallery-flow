      ...
      <div className="relative h-full flex items-center">
        <div className="container mx-auto px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-200 mb-12 font-light tracking-wide max-w-xl">
              Where timeless craftsmanship meets contemporary sophistication
            </p>
            <Link to="/gallery">
              <Button className="bg-transparent hover:bg-zeof-gold border-2 border-zeof-gold text-white px-8 py-6 text-sm tracking-wider transition-all duration-300 rounded-none uppercase">
